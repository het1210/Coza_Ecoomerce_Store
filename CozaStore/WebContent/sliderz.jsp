                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form action="Addpic" method="post"  class="needs-validation" novalidate enctype="multipart/form-data">
                                           
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="validationCustom03">Banner Name</label>
                                                        <input type="text" name="name" class="form-control" id="validationCustom03" placeholder="Banner Name" required>
