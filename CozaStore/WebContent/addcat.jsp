...
<head>
 ...
 <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Form/</span>Add Category</h4>
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form action="AddCategory" method="post"  class="needs-validation" novalidate enctype="multipart/form-data">
                                           
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="validationCustom03">Category Name</label>
                                                        <input type="text" name="category" class="form-control" id="validationCustom03" placeholder="Category Name" required>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="file" name="cimage" class="form-control" id="validationCustom04" placeholder="Image" required accept="image/*" onchange="loadFile(event)">
                                                        <div class="invalid-feedback" >
