...
#id::before {
 ...
 <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Data/</span><SHADOW></SHADOW> Product</h4>

					<%
						Dao dao = new Dao();
						List<Product> list = dao.viewProduct();
								...
								<tbody>
									<c:forEach var="p" items="${product}">
										<tr>
											...
											<td><img src="images/products/${p.image1}" style="height: 30px; width: 60px;" ></td>
											<td>${p.qty}</td>
											<td>${p.price}</td>
											<%-- <td>${p.description}</td> --%>
													<td align="center"><a href="EditProduct?id=${p.id}">
											   <i class="fa fa-edit" onclick="return confirm('Sure you want to Update the data?')" style="font-size: 18px"></i></a>
											</td>
											<td align="center"><a href="DeleteProduct?id=${p.id}">
											    <i class="fa fa-trash" onclick="return confirm('Sure you want to delete the data?')" style="font-size: 18px"></i></a>
									        </td>
										</tr>
									</c:forEach>
								</tbody>
