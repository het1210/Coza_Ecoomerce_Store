      ...
      <div class="col-md-9 personal-info">
        ...
        <h3>Change Password</h3><br>
				...
				<div style="width: 565px;"
					...
					role="alert">
					<strong> New Password</strong> and Confirm Password Not Match!.
				...
				<div style="width: 565px;"
					class="alert alert-warning alert-dismissible fade show"
					role="alert">
					<strong>Your</strong> Old Password is Wrong!.
					<button type="button" class="close" data-dismiss="alert"
						aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
				...
				<div style="width: 565px;"
					class="alert alert-warning alert-dismissible fade show"
					role="alert">
					<strong>Some</strong> thing went Wrong! Try again!.
					<button type="button" class="close" data-dismiss="alert"
						aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
				...
				<form action="User_ChangePass" method="post" class="form-horizontal" role="form">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <input class="form-control" type="password" name="cnew_password" required="required"
              pattern="(?=^.{8,}$)(?=.*\d)(?=.*[!@#$%^&*]+)(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$">
            </div>
          </div>
          <div class="form-group">
            ...
            <div class="col-md-8">
			<button class="flex-c-m stext-101 cl0 size-107 bg3 bor2 hov-btn3 p-lr-15 trans-04 m-b-10">Change Password</button>
            </div>
          </div>
        </form>
      </div>
