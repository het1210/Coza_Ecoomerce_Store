  ...
  <body>
    ...
    <div class="container-xxl">
      <div class="authentication-wrapper authentication-basic container-p-y">
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to Coza Store</h4>
						<form action="admin_newPassword" method="POST" autocomplete="off">
                <div class="mb-3">
		...
		<div class="mb-3">
                  <label for="email" class="form-label">Confirm NewPassword</label>
                  <input
                    type="password"
                    class="form-control"
                    id="email"
                ...
                <div class="mb-3">
                    <input type="submit" name="login" style="background-color:#f48e7ce6;" class="btn d-grid w-100 text-white" value="Update Password">
                </div>
              </form>
