        ...
        <div class="authentication-inner">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- /Logo -->
              <h4 class="mb-2">Enter your Otp: </h4>
						<%
		  ...
		  %>
						<form action="admin_ValidateOtp" method="POST" autocomplete="off">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <input type="submit" name="login" style="background-color:#f48e7ce6" class="btn d-grid w-100 text-white" value="New Password">
                </div>
              </form>
