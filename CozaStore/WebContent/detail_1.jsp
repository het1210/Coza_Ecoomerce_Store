...
<div class="content-wrapper">
              <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Form/</span>Order Details</h4>
<section class="invoice">
      ...
      <div class="row invoice-info">
        <div class="col-sm-4 invoice-col">
          ...
          <address>
              <strong>Order Date: </strong>${list.orderDate}<br>
            <strong>Email:</strong> ${list.user.email}<br>
        ...
        <div class="col-sm-4 invoice-col">
          ...
          <b>Order ID: </b>${list.orderId}<br>
          <b>Contact No:</b> ${list.user.contact}<br>
      ...
      <%
						Dao dao2 = new Dao();
						List<Order> list2 = dao2.viewOrder();
						session.setAttribute("order", list2);
					%>
      <div class="row">
      ...
      <div class="row">
        ...
        <div class="col-xs-6">
          ...
          <div class="table-responsive">
            <table class="table">
              <tbody><tr>
                <th style="width:30%"><p>Total Price:</p></th>
                <th><p>655</p></th>
              </tr>
