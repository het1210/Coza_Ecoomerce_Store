                            ...
                            <div class="col-xl-12">
                                <div class="card">
                                    <div class="card-header">
										...
										%>
										<div class="card-body">
                                        <form action="addproduct"  method="post"  class="needs-validation" novalidate enctype="multipart/form-data">
                                           
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="validationCustom03">Product Name</label>
                                                        <input type="text" name="productName" class="form-control" id="validationCustom03" placeholder="Product Name" required>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="qty" class="form-control" id="validationCustom03" placeholder="Enter Qty" required>
                                                        <div class="invalid-feedback">
                                             ...
                                             <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="price" class="form-control" id="validationCustom03" placeholder="Enter Price" required>
                                                        <div class="invalid-feedback">
                                                ...
                                                <div class="col-md-6">
                                                 ...
                                                 <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="materials"  class="form-control" id="validationCustom03" placeholder="Enter materials %" required>
                                                        <div class="invalid-feedback">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group label-floating">
														...
														<option value="" disabled hidden selected>Choose Color</option>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="weight" class="form-control" id="validationCustom03" placeholder="Enter Weight" required>
                                                        <div class="invalid-feedback">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="dimensions" class="form-control" id="validationCustom03" placeholder="Enter Dimensions  12*34*56" required>
                                                        <div class="invalid-feedback">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea rows="6" cols="15" class="form-control" name="description" id="validationCustom03" placeholder="Enter Description" required></textarea>
                                                        <div class="invalid-feedback">
