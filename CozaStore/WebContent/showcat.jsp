...
#id::before {
 ...
 <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Data/</span><SHADOW></SHADOW> Category</h4>
					<%
						Dao dao = new Dao();
				...
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							<table style="overflow-x:auto;" id="datatable-buttons"
								...
								<tbody>
									<c:forEach var="cat" items="${category}">
										<tr>
											...
											<td>${cat.category}</td>
											<td><img src="images/products/${cat.cimage}"
												style="height: 30px; width: 60px;"></td>
											<td align="center"><a href="EditCategory?id=${cat.cid}"><i
															class="fa fa-edit" onclick="return confirm('Sure you want to Update the data?')"  style="font-size: 18px"></i></a></td>
													<td align="center"><a
														href="DeleteCategory?id=${cat.cid}"><i
															class="fa fa-trash" onclick="return confirm('Sure you want to delete the data?')" style="font-size: 18px"></i></a></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
