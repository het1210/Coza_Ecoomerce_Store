		...
		<div class="container">
			...
			<div class="row isotope-grid">
				<c:if test="${empty products}">
					<h1 align="center">Opps No products found.</h1>
				</c:if>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							...
							<a href="product-detail.jsp?id=${p.id}" class="block2-btn flex-c-m stext-103 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 ">
								Quick View
							</a>
						</div>
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product-detail.jsp?id=${p.id}" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6 ">
									${p.productName}
