...
#id::before {
 ...
 <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Data/</span><SHADOW></SHADOW>All Orders</h4>
                                    ...
                                    <div style="overflow-x:auto;" class="card-body">
                                        <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                            ...
                                            <td id="id"></td>
                                                ...
                                                <td>${o.amount}</td>
                                                <td>${o.status}</td>
                                                 <td align="center"><a href="orderdetail?orderId=${o.orderId}"><i
															class="fa fa-info"  style="font-size: 18px"></i></a></td>
